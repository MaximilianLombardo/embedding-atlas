...
// Cards-as-chart-builder was removed alongside the Table/Cards toggle
// in Instances.svelte. The Cards.svelte component itself remains in
// the codebase for future reuse (see comment block in Instances).
