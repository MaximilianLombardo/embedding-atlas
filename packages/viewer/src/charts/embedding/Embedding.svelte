...
<script lang="ts">
  ...
  // Register an "Embed" tab in the page-level settings panel.
...
<div class="relative">
  ...
  <div class="absolute top-0 left-0 right-0 flex flex-wrap justify-between items-start pointer-events-none">
    ...
    <!-- The in-pane Color picker + Settings popup that previously
         ...
         page-level settings panel (registered via registerDelegate
         above). The panel is the single home for chart-scoped
