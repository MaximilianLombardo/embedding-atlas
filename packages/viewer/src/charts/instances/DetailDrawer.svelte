...
{#if row != null}
  ...
  <div class="fixed inset-0 z-50 flex justify-end">
    ...
    >
      <!-- Sticky header: stays visible as the body scrolls. Holds the
           drawer title, optional Show-in-table action, and close X. -->
      <div
        class="sticky top-0 z-10 flex items-center justify-between gap-2 px-4 py-2 border-b border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm"
      >
